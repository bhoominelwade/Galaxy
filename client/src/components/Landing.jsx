  ...
  return (
    <div className="flex gap-16 justify-end items-center p-2"> 
      ...
      <a href="#" className="hover:opacity-80 transition-opacity">
        <img 
          src="https://galaxyrailway-production.up.railway.app/public/textures/TweetX.png" 
          alt="Twitter Icon" 
      ...
      <a href="#" className="hover:opacity-80 transition-opacity">
        <img 
          src="https://galaxyrailway-production.up.railway.app/public/textures/ndex.png" 
          alt="Dex Icon" 
      ...
      <a href="#" className="hover:opacity-80 transition-opacity">
        <img 
          src=".https://galaxyrailway-production.up.railway.app/public/textures/notess-removebg-preview.png" 
          alt="Notes Icon" 
          style={{ 
